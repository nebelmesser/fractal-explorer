...
`;function te(n){return new Worker(""+new URL("tile-worker-BEPpdRrw.js",import.meta.url).href,{type:"module",name:n?.name})}let w=null,oe=1,F=0;const A=new Map,k=[],sn=[];function z(){const n=typeof navigator>"u"?4:navigator.hardwareConcurrency??4;return Math.max(1,Math.min(In,n-1))}function re(){return z()}function se(){const n=k.pop();return n?Promise.resolve(n):new Promise(e=>sn.push(e))}function H(n){if(!w?.includes(n))return;const e=sn.shift();e?e(n):k.push(n)}function ie(n){const e=A.get(n.data.id);if(e){if(A.delete(n.data.id),!n.data.buffer||n.data.error){e.reject(new Error(n.data.error??"Magnets CPU worker returned no buffer"));return}e.resolve(n.data.buffer)}}function W(){const n=new te;return n.onmessage=ie,n.onerror=e=>Q(n,new Error(e.message||"Magnets CPU worker failed")),n.onmessageerror=()=>Q(n,new Error("Magnets CPU worker message error")),n}function Q(n,e){for(const[s,a]of A)a.worker===n&&(A.delete(s),a.reject(e));const r=k.indexOf(n);if(r>=0&&k.splice(r,1),!w)return;const o=w.indexOf(n);if(o<0)return;w.splice(o,1);try{n.terminate()}catch{}const i=W();w.push(i),H(i)}function ae(){if(!w)return;F+=1;const n=new Set(w);w=[],k.length=0;const e=new Error("Magnets CPU tile superseded by a newer camera");e.name="AbortError";for(const[r,o]of A)n.has(o.worker)&&(A.delete(r),o.reject(e));for(const r of n)try{r.terminate()}catch{}for(let r=0;r<z();r++){const o=W();w.push(o),H(o)}}function ce(){if(!w){w=[];for(let n=0;n<z();n++){const e=W();w.push(e),k.push(e)}}}function le(n,e){return new Promise((r,o)=>{A.set(e.id,{worker:n,resolve:r,reject:o}),n.postMessage(e)})}async function ue(n,e,r,o){ce();const i=F,s=await se();try{if(i!==F){const c=new Error("Magnets CPU tile superseded before dispatch");throw c.name="AbortError",c}const a=await le(s,{id:oe++,width:Math.max(1,Math.round(e)),height:Math.max(1,Math.round(r)),xMin:n.xMin,xMax:n.xMax,yMin:n.yMin,yMax:n.yMax,K:o.K??nn,G:o.G??en,F:o.F??tn,H:o.H??on,R:o.R??R,DT:o.DT??rn,maxIter:Math.max(P,Math.round(o.MAX_ITERATIONS??P))});return new Float32Array(a)}finally{H(s)}}function fe(n,e,r,o,i){const s=new ArrayBuffer(80),a=new Float32Array(s),c=new Uint32Array(s);a[0]=n.xMin,a[1]=n.xMax,a[2]=n.yMin,a[3]=n.yMax,a[4]=o.K,a[5]=o.G,a[6]=o.F,a[7]=o.H,a[8]=o.DT,a[9]=D*D,a[10]=o.R??R,a[11]=0,c[12]=Math.max(P,Math.round(o.MAX_ITERATIONS??P)),c[13]=e,c[14]=r,c[15]=0,c[16]=0;const u=un(n,i.normView??n,e,r);return c[17]=u.y0<<16|u.x0,c[18]=u.y1<<16|u.x1,c[19]=1,s}const de={computeWgsl:ee,entryPoint:"simulate",uniformBytes:80,packUniforms:fe},pe={id:"magnets",title:"Magnetic pendulum",settledResolution:{gpu:"device",cpu:"adaptive"},defaultView:{xMin:-C,xMax:C,yMin:-C,yMax:C},workBudget:{param:"MAX_ITERATIONS",min:P,max:Un,step:50},params:[{key:"R",label:"param.R",kind:"float",min:kn,max:Rn,step:.01,default:R},{key:"K",label:"param.K",kind:"float",min:.1,max:3,step:.01,default:nn},{key:"G",label:"param.G",kind:"float",min:.05,max:2,step:.01,default:en},{key:"F",label:"param.F",kind:"float",min:0,max:.8,step:.01,default:tn},{key:"H",label:"param.H",kind:"float",min:.08,max:.8,step:.01,default:on},{key:"DT",label:"param.DT",kind:"float",min:.005,max:.05,step:.001,default:rn,invert:!0,digits:3}],gpu:de,cpu:{fillTile:ue,cancelPending:ae,concurrency:re()}};async function me(){await fn(),await dn(pe,ne),pn(),mn()}me();
